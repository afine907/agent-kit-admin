"""Review 模型 - 权威来源: docs/architecture/04-data-model.md"""

import uuid
from sqlalchemy import Column, Text, SmallInteger, DateTime, func, UniqueConstraint, ForeignKey, CheckConstraint
